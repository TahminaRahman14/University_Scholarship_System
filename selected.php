...
$sql = "SELECT application.S_id, student_info.FullName, student_info.major, scholarship.Schol_name FROM application, student_info, scholarship WHERE application.S_id=student_info.S_id and application.Schol_id=scholarship.Schol_id and application.status='a'";
  ...
  <div class="d-flex" id="wrapper">
    ...
    <nav id="sidebar">
      ...
      <ul class="list-unstyled components">
        ...
        <li>
          <a href="admin.php"><i class="fa fa-tachometer"></i><span style="margin-left: 10px;"></span>Pending
            Applications</a>
        </li>
        <li>
          <a href="selected.php"><i class="fa fa-tachometer"></i><span style="margin-left: 10px;"></span>Selected
            Students</a>
        </li>
        <li>
          <a href="#"><i class="fa fa-tachometer"></i><span style="margin-left: 10px;"></span>Logout</a>
        </li>
      </ul>
