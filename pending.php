    ...
    //eita apnar sql ei page er jonno, onno page r ki vul korchen ta jani na vaiya onno page a..run kore dekhi
    ...
    //vaiya akhane to $id ta pabe na..eta ki krbo url thike dhorrte hobe
    //hmm :Dhoye gese vaiya..ami to status change dekhlam na  vaiya 2nd ta to a hoise vaia thik ache na ,seita to apni bolben, apnar requirement onujayi sob cholche kina...ji vaiya thik ache :D vaiya thank you so much ^_^
    //vaiya apni ki achen?
    //ji vaiya thik ache..thanks help korar jnno :D apni ghumaben na? apnar kaj sesh korte parchi? Ji vaiya..ektu bole den check results ta ki krbo..oita e only baki, jodi approve kore, status a paben, a paile msg dekhaben approve, p paile msg dekhaben pending...vaiya eta to select diye where clause dibo na?database data asha manei select, tar sathe jodi apnar condition dorkar pore where diben...ok vaiya..taile to check result page a if else condition a just sql dibo? sql chalaye value niye asben, tarpor seita check korben ki paile ki dekhaite chan...ji vaiya bujhsi mone hoy
    ...
    <div class="d-flex" id="wrapper">
        ...
        <ul class="list-unstyled components">
            <li>
            <a href=""><i class="fa fa-tachometer"></i><span style="margin-left: 10px;"></span>Dashboard</a>
            </li>
            <li>
            <a href="admin.php"><i class="fa fa-tachometer"></i><span style="margin-left: 10px;"></span>Pending Applications</a>
            </li>
            <li>
            <a href=""><i class="fa fa-tachometer"></i><span style="margin-left: 10px;"></span>Selected Students</a>
            </li>
            <li>
            <a href="selected.php"><i class="fa fa-tachometer"></i><span style="margin-left: 10px;"></span>Logout</a>
            </li>
            </ul>
        ...
        <div class="container-fluid">
            ...
            <div class="col-10">
                ...
                <div class="card-body">
                    ...
                    <label for="mail">Questions : </label>
